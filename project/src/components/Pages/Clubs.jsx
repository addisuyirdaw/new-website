            ...
            <div className="bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
              <div className="p-6">
                ...
                <div className="flex justify-center space-x-4">
                  ...
                  {(user?.isAdmin || user?.username === 'dbu10101040' || user?.role === 'clubs_coordinator' || ((user?._id || user?.id) && (selectedClubDetails?.leadership?.president === (user?._id || user?.id) || selectedClubDetails?.leadership?.president?._id === (user?._id || user?.id)))) && (
                    <>
                      <button
